...
For **Zed 主题机制研究**（对照用，勿拷 GPL 源码）, see [ZED_THEME.md](./ZED_THEME.md).  
...
- [x] Persistence events (AppBus / WillQuit / PersistRequested) — see [PERSISTENCE_EVENTS.md](./PERSISTENCE_EVENTS.md)
